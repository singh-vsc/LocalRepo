define([
    ...
    function ($, _, Hypr, Backbone, api, CustomerModels, AddressModels, PaymentMethods, HyprLiveContext) {
        ...
        var CheckoutStep = Backbone.MozuModel.extend({
            ...
            initStep: function () {
                console.log("model-checkout initStep");
                var me = this;
            ...
            next: function () {
                console.log("model-checkout next");
        ...
        FulfillmentContact = CheckoutStep.extend({
            ...
            initialize: function () {
                ...
                this.on('change:contactId', function (model, newContactId) {
                    console.log("Model : FulfillmentContact : "+JSON.stringify(model)+" newContactId : "+newContactId);
            ...
            calculateStepStatus: function () {
                console.log("Model : FulfillmentContact : "+JSON.stringify(this.model));
        ...
        FulfillmentInfo = CheckoutStep.extend({
            ...
            updateShippingMethod: function (code, resetMessage) {
                console.log("FulfillmentInfo : updateShippingMethod : "+code);
                ...
                console.log("FulfillmentInfo : updateShippingMethod : newMethod : "+newMethod);
                if (newMethod) {
                    this.set(newMethod);
                    this.applyShipping(resetMessage);
                    console.log("FulfillmentInfo : updateShippingMethod : newMethod : "+JSON.stringify(this.model));
                }
            },
            applyShipping: function(resetMessage) {
                ...
                if (order) {
                    order.apiModel.update({ fulfillmentInfo: me.toJSON() })
                        .then(function (o) {
                            console.log("Updated Order with me : "+JSON.stringify(order));
